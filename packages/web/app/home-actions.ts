...
export type Category = { id: string; name: string; count: number; icon?: string };
export type GenCard = {
  id: string;
  title: string;
  tags: string[];
...
export const getPopular = cache(async (): Promise<GenCard[]> => {
  return [
    { id: 'p1', title: 'Изучаем время на часах', tags: ['математика', 'логика'], views: 156, likes: 52 },
    { id: 'p2', title: 'Лабиринты для развития логики', tags: ['логика'], views: 89, likes: 34 },
    { id: 'p3', title: 'Сложение в пределах 100', tags: ['математика'], views: 203, likes: 112 },
    { id: 'p4', title: 'Творческие задания', tags: ['творчество'], views: 74, likes: 28 },
  ];
});

export const getNewest = cache(async (): Promise<GenCard[]> => {
  return [
    { id: 'n1', title: 'Найди отличия', tags: ['внимание'], views: 62, likes: 22 },
    { id: 'n2', title: 'Лабиринт «Космос»', tags: ['логика'], views: 47, likes: 18 },
    { id: 'n3', title: 'Пишем буквы', tags: ['письмо'], views: 83, likes: 31 },
    { id: 'n4', title: 'Сложение и вычитание', tags: ['математика'], views: 98, likes: 40 },
  ];
});

export const getTop = cache(async (): Promise<Array<{ rank: number; title: string; views: number }>> => {
  return [
