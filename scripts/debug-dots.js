...
function parseArgs(argv) {
  const args = { input: 'base.jpg', output: undefined, points: 50, threshold: 180 };
  for (let i = 2; i < argv.length; i++) {
    ...
    if (a === '--input' || a === '-i') args.input = argv[++i];
      ...
      console.log('Usage: node scripts\\debug-dots.js [--input path] [--output path] [--points N] [--threshold N]');
      process.exit(0);
    }
  }
  return args;
